  ...
  cars$: Observable<Car[]> = of([
    {
      ...
      maker: 'Chevrolet',
      model: 'Sportvan G20',
      year: new Date('2020-01-02').toISOString(),
    },
    {
      id: 2,
      maker: 'Jeep',
      model: 'Patriot',
      year: new Date('2021-01-02').toISOString(),
    },
    {
      id: 3,
      maker: 'Ferrari',
      model: '612 Scaglietti',
      year: new Date('2021-02-02').toISOString(),
    },
    {
      id: 4,
      maker: 'Ford',
      model: 'Thunderbird',
      year: new Date('2022-01-02').toISOString(),
    },
    {
      id: 5,
      maker: 'GMC',
      model: 'Canyon',
      year: new Date('2023-01-02').toISOString(),
    },
