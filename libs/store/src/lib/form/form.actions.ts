...
export const updateData = createAction('[Form] UPDATE_DATA', props<{ data: any }>());
export const setStructure = createAction('[Form] SET_STRUCTURE', props<{ structure: any }>());
export const setErrors = createAction('[Form] SET_ERRORS', props<{ errors: FieldErrors }>());
